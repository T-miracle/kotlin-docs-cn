...
_[Released: 24 August 2021](releases.md#发布详情)_
...
An _exhaustive_ [`when`](control-flow.md#when表达式) statement contains branches for all possible types or values of its subject or for some types plus an `else` branch. In other words, it covers all possible cases.
