...
### Generation of TypeScript declaration files in Kotlin/Wasm {id=generation-of-typescript-declaration-files-in-kotlin-wasm}
...
### Improved Gradle dependency handling for CInteropProcess in Kotlin/Native {id=improved-gradle-dependency-handling-for-cinteropprocess-in-kotlin-native}
...
### Kotlin/Native compiler downloaded when needed {id=kotlin-native-compiler-downloaded-when-needed}
