...
[//]: # (description: 了解 Kotlin 特性生命周期。此页面包含 Kotlin 语言特性和设计提案的完整列表。)

JetBrains 根据 [Kotlin 语言演进原则](kotlin-evolution-principles.md) 逐步发展 Kotlin 语言，遵循务实的设计理念。

> 语言特性提案从 Kotlin 1.7.0 开始列出。
>
> 请参阅 [Kotlin 演进原则文档](kotlin-evolution-principles.md#pre-stable-features) 了解语言特性状态的说明。
